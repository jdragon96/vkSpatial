...
namespace Engine::Spatial {
    ...
    void WideBVH::BuildFromPrimitives(const std::vector<Primitive> &prims) {
        ...
        auto boundsInit = mk("BVH/kernel_bvh_wide_bounds_init.comp.glsl");
        auto boundsReduce = mk("BVH/kernel_bvh_wide_bounds_reduce.comp.glsl");
        auto morton = mk("BVH/kernel_bvh_wide_morton.comp.glsl");
        auto histogram = mk("BVH/kernel_bvh_radixSort_histogram.comp.glsl");
        auto prefixScan = mk("BVH/kernel_bvh_radixSort_prefixScan.comp.glsl");
        auto reorder = mk("BVH/kernel_bvh_radixSort_reorder.comp.glsl");
        auto hierarchy = mk("BVH/kernel_bvh_hierarchy.comp.glsl");
        auto boundingBox = mk("BVH/kernel_bvh_boundingBox.comp.glsl");
        auto rangeInit = mk("BVH/kernel_bvh_wide_range_init.comp.glsl");
        auto range = mk("BVH/kernel_bvh_wide_range.comp.glsl");
        auto wideInit = mk("BVH/kernel_bvh_wide_build_init.comp.glsl");
        auto wideBuild = mk("BVH/kernel_bvh_wide_build.comp.glsl");
    ...
    void WideBVH::setupQueryKernels() {
        ...
        m_radiusKernel->Build("BVH/kernel_cmd_radiusSearch_wide.comp.glsl")
        ...
        m_knnKernel->Build("BVH/kernel_cmd_knn_wide.comp.glsl")
                .Bind(0, *m_nodeBuf).Bind(1, *m_leafBuf).Bind(2, *m_sortedMortonBuf)
