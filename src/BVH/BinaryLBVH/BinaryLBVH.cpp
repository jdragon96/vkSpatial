...
namespace Engine::Spatial {
    ...
    void BinaryLBVH::BuildFromPrimitives(const std::vector<Primitive> &prims) {
        ...
        ComputePipeline(*m_ctx)
                .Build("BVH/kernel_bvh_mortonCode.comp.glsl")
                .Bind(0, *m_mortonBuf)
                .Bind(1, *m_primBuf)
                .Args(mpc)
                .DispatchElements(N);
        ...
        ComputePipeline(*m_ctx)
                .Build("BVH/kernel_bvh_hierarchy.comp.glsl")
                .Bind(0, *m_mortonBuf)
                .Bind(1, *m_primBuf)
                .Bind(2, *m_nodeBuf)
        ...
        ComputePipeline(*m_ctx)
                .Build("BVH/kernel_bvh_boundingBox.comp.glsl")
                .Bind(0, *m_nodeBuf)
    ...
    void BinaryLBVH::stepSortMortonCodes() {
        ...
        histogram.Build("BVH/kernel_bvh_radixSort_histogram.comp.glsl");
        prefixScan.Build("BVH/kernel_bvh_radixSort_prefixScan.comp.glsl");
        reorder.Build("BVH/kernel_bvh_radixSort_reorder.comp.glsl");
    ...
    void BinaryLBVH::setupQueryKernels() {
        ...
        m_knnKernel->Build("BVH/kernel_cmd_knn.comp.glsl")
                .Bind(0, *m_nodeBuf)
                .Bind(1, *m_knnResultBuf)
                .Bind(2, *m_knnDistBuf);

        m_radiusKernel = std::make_unique<ComputePipeline>(*m_ctx);
        m_radiusKernel->Build("BVH/kernel_cmd_radiusSearch.comp.glsl")
                .Bind(0, *m_nodeBuf)
