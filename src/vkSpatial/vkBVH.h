...
namespace vkSpatial {
    ...
    private:
        ...
        std::unique_ptr<vkCommon::vkGPUMemory> m_primBuf;         // Primitive[]
        std::unique_ptr<vkCommon::vkGPUMemory> m_mortonBuf;       // MortonCode[] (ping)
        std::unique_ptr<vkCommon::vkGPUMemory> m_mortonPingBuf;   // MortonCode[] (pong)
        std::unique_ptr<vkCommon::vkGPUMemory> m_histBuf;         // radix sort histogram
