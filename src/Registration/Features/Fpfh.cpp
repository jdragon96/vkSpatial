...
namespace Features {
    ...
    namespace {
        ...
        Grid BuildGrid(const Common::PointCloud &cloud, float cellSize) {
            Grid grid;
        ...
        void QueryRadius(const Common::PointCloud &cloud, const Grid &grid, float cellSize,
        ...
        Fpfh33 ComputeSpfh(const Common::PointCloud &cloud, int p, const std::vector<int> &neighbors) {
    ...
    std::vector<Fpfh33> ComputeFpfh(const Common::PointCloud &cloud, float normalRadius, float fpfhRadius) {
